...
主な特徴として、まず特筆すべきなのは高い可用性です。耐障害性に優れたSSDストレージ設計や最大15個のリードレプリカ、AZ間の自動レプリケーションなどによって、99.99%の可用性を提供するように設計されています。
...
つまり、「使い慣れた構文でアクセスできる」「ユースケースに応じてクエリ言語を選べる」というのも、Neptuneの大きな特徴です。
...
## Amazon Neptuneの魅力
私のNeptuneの推しポイントは、簡単にノードとエッジで構成されたグラフデータベースを構築し、つながりを表現できる点です。
