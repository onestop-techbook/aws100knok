...
## 会場下見、リハーサル　～初回イベントへの最終調整～
初回イベント開催1週間前に、実際の会場の下見とリハーサルを行いました。<br/>
...
## いざ初回イベント本番へ<br>～満員御礼、大盛り上がりの懇親会～
いよいよ初回イベント本番です。
...
　→ 会場入り口での誘導
* オンライン参加対応<br/>
　→ Zoom配信設定、録画、Zoomでのコメント・質問への対応
* タイムキーパー<br/>
　→ LTのタイムキープ
* SNSでの情報発信<br/>
　→ イベントの様子について公式アカウント（後日作成）で定期的にSNS投稿
* 懇親会<br/>
　→ 人数確定後のお店への連絡、会場移動の誘導、乾杯・締めの挨拶<br/>
<br/>
