...
GraphQLやAppSync、DynamoDBといった普段使い慣れない方も多いサービスを中で使っていますが、その実Amplify Dataがうまくそれを秘匿していて、新しく **Amplify Dataの記法** になれる必要はあれど、学習コストは非常に低いと考えています。
...
また、今回深く触れていませんが、開発者自身がローカルPC上でAmplify Gen2を用いたアプリ開発をしていても、Amplify Sandboxというものを用いて、CloudFormationを通してクラウド上に構築されたバックエンドリソース/インフラリソースを使うことできます。これは、実際にデプロイする際の環境とほぼ同じ環境を用意できることで、さらに円滑な構築体験につながりました。
