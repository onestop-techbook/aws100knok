...
「みんなのAWS推しポイント」ということで、私からは**インプット/アウトプットの場としてのコミュニティの魅力**をお伝えしたいと思います。
...
JAWS-UGの一参加者から始まり、自分にできる小さな範囲の発信を繰り返すことでアウトプットへの挑戦→成長のサイクルが定着してきましたので、

以前の私のように「アウトプットに関心があるもののあと一歩が踏み出せない方」に向けて、本章をお届けいたします。
